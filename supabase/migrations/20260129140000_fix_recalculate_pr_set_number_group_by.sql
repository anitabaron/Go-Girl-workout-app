-- ============================================================================
-- Migration: Fix wss.set_number GROUP BY error in recalculate_pr_for_exercise
-- ============================================================================
-- Purpose: Fix SQL error "column wss.set_number must appear in the GROUP BY
--          clause or be used in an aggregate function" when saving exercise
--
-- Root cause: In max_duration and max_weight INSERT blocks, wss.set_number
--             is selected directly from a JOIN that can return multiple rows.
--             Use scalar subquery instead to avoid ambiguity.
--
-- Dependencies:
--   - 20260129130000_fix_save_exercise_null_and_recalculate_pr.sql
-- ============================================================================
...
begin
    ...
    -- ========================================================================
    -- MAX DURATION PR - Use scalar subquery for achieved_in_set_number
    -- ========================================================================
    ...
    -- ========================================================================
    -- MAX WEIGHT PR - Use scalar subquery for achieved_in_set_number
    -- ========================================================================
