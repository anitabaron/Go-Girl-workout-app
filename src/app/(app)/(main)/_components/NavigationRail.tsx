...
const NAV_ITEMS = [
  ...
  { href: "/workout-plans", label: "Plans", icon: Calendar },
  { href: "/workout-sessions", label: "Sessions", icon: History },
  { href: "/personal-records", label: "Records", icon: Trophy },
  { href: "/workout-sessions/start", label: "Start", icon: Play },
] as const;
