  ...
  return (
    <AuthProvider user={user}>
      <div className="ui-m3 min-h-dvh w-full bg-background text-foreground flex flex-col overflow-visible">
        ...
        <main className="relative z-0 flex-1 w-full min-w-0 mx-auto max-w-4xl px-4 py-6 sm:px-6 sm:py-8 md:pl-[104px] lg:pl-[112px] pb-[var(--m3-mobile-nav-height)] md:pb-8">
          {children}
        </main>
      </div>
