...
import { UnilateralDisplayProvider } from "./UnilateralDisplayContext";
 ...
 * Uses M3-styled components and redirects to /workout-sessions on exit.
 */
export function WorkoutSessionAssistantM3({
  ...
  const {
    ...
    sessionId,
    initialSession,
    exitHref: "/workout-sessions",
  });

  if (!currentExercise) {
    return (
      <div className="flex min-h-[50vh] items-center justify-center">
        <p className="m3-body">No exercises in session</p>
      </div>
    );
  }
  ...
  return (
    <UnilateralDisplayProvider>
      <div className="flex min-h-[50vh] flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto pb-[6.25rem] md:pb-24 md:pt-4">
        ...
        <div className="fixed left-0 right-0 bottom-above-mobile-nav z-40 border-t border-[var(--m3-outline-variant)] bg-[var(--m3-surface-container)] p-4 shadow-[0_-2px_10px_rgb(0_0_0/0.08)] md:bottom-0 md:left-[80px] md:shadow-[0_-2px_10px_rgb(0_0_0/0.08)] xl:right-[420px]">
