...
export function EmptyState() {
  return (
    <Card className="mx-auto min-w-[320px] max-w-md rounded-2xl border border-border bg-white shadow-sm dark:border-border dark:bg-zinc-950" data-test-id="exercises-empty-state">
