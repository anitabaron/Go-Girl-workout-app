...
export const enMessages = {
  ...
  "exerciseLabels.part.shoulders": "Shoulders",
  "exerciseLabels.part.fullbody": "Full Body",
  ...
  "importSessionButton.fileMustBeJson": "File must be in JSON format",
  "importSessionButton.importError": "Error during import",
  "importSessionButton.sessionImportedSuccess":
    "Workout session imported and marked as completed",
  "importSessionButton.importGenericError": "An error occurred during import",
  "importSessionButton.selectJsonAria": "Select JSON file",
  "importSessionButton.importAria":
    "Import a completed workout session from a JSON file",
  "importSessionButton.importing": "Importing...",
  "importSessionButton.importJson": "Import completed workout",
  "importSessionButton.instructions": "Import instructions",
  ...
  "workoutPlanMetadata.partOption.shoulders": "Shoulders",
  "workoutPlanMetadata.partOption.fullbody": "Full Body",
  "workoutPlanMetadata.partOption.full body": "Full Body",
  ...
  "workoutPlanExerciseItem.partOption.shoulders": "Shoulders",
  "workoutPlanExerciseItem.partOption.fullbody": "Full Body",
  ...
  "exerciseSelector.partOption.shoulders": "Shoulders",
  "exerciseSelector.partOption.fullbody": "Full Body",
  ...
  "exerciseForm.partOption.shoulders": "Shoulders",
  "exerciseForm.partOption.fullbody": "Full Body",
  ...
  "workoutSessionDetailContent.cancelEditAria": "Finish editing",
  "workoutSessionDetailContent.cancelEdit": "Finish editing",
  ...
  "workoutSessionDetailContent.repeatSessionAria": "Do this session again",
  "workoutSessionDetailContent.repeatSession": "Do again",
  "workoutSessionDetailContent.repeating": "Starting...",
  "workoutSessionDetailContent.repeatError": "Couldn't start the repeat workout.",
  ...
  "statisticsPage.manualWorkoutAddButton": "Add workout from outside app",
  ...
  "statisticsPage.manualWorkoutNotesLabel": "Notes (optional)",
  ...
  "statisticsPage.manualWorkoutInvalidAvgHeartRate":
    "Avg heart rate must be between 1 and 260 bpm.",
  "statisticsPage.manualWorkoutInvalidMaxHeartRate":
    "Max heart rate must be between 1 and 260 bpm.",
  "statisticsPage.manualWorkoutInvalidHeartRateOrder":
    "Max heart rate cannot be lower than avg heart rate.",
  "statisticsPage.manualWorkoutInvalidRpe":
    "RPE must be an integer between 1 and 10.",
  "statisticsPage.externalSportTypePoleDance": "Pole dance",
  "statisticsPage.externalSportTypeCalisthenics": "Calisthenics",
  "statisticsPage.externalSportTypeOther": "Other",
  "statisticsPage.externalSourceManual": "Manual",
  ...
  "statisticsPage.sessionExternalSportTypeLabel": "Sport type",
  "statisticsPage.sessionExternalSourceLabel": "Source",
  "statisticsPage.sessionCaloriesLabel": "Calories",
  "statisticsPage.sessionAvgHeartRateLabel": "Avg heart rate",
  "statisticsPage.sessionMaxHeartRateLabel": "Max heart rate",
  "statisticsPage.sessionRpeLabel": "Intensity RPE",
  "statisticsPage.sessionNotesLabel": "Notes",
